...
module.exports = new class {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.commands.add("atom-workspace", {
      ...
      "copy-path:copy-full-dirname-concat-with-clipboard": (e) => this.copyFullDirnameConcatWithClipboard(e)
    }));
  ...
  copyFullDirnameConcatWithClipboard(e) {
    const {dir} = this.parseTargetEditorPath(e);
    const basename = atom.clipboard.read();
    atom.clipboard.write( path.join(dir, basename) );
  }
